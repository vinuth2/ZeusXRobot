...
class Config(object):
    ...
    TOKEN = "2116046406:AAFZ6LByMeijxz6nlcEtALmCw6SRBiiicVM"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    SUPPORT_CHAT = 'Zeussupportchat'  #Your own group for support, do not add the @
