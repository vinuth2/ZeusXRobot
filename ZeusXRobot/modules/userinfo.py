...
from telegram import MAX_MESSAGE_LENGTH, ParseMode, __version__ as ptbver, Update
...
from ZeusXRobot.modules.sql.afk_sql import is_afk, check_afk_status
from ZeusXRobot.modules.sql.users_sql import get_user_num_chats
from ZeusXRobot.modules.helper_funcs.chat_status import sudo_plus
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + "\n╘══「 by ⚡CT_PRO⚡ 」\n", parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(  [ InlineKeyboardButton( text="Support", url=f"https://t.me/ZeusSupportchat"), InlineKeyboardButton( text="Updates", url="https://t.me/Zeusupdates") ] ] ), disable_web_page_preview=True, ) except BaseException: update.effective_message.reply_text( ( ( ( "\n*Bot statistics*:\n" + "\n".join(mod.__stats__() for mod in STATS) ) + "\n\n \n\n" ) + "╘══「 by ⚡CT_PRO⚡ 」\n" ), parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton( text="Support", url=f"https://t.me/ZeusSupportchat"), InlineKeyboardButton( text="Updates", url="https://t.me/Zeusupdates") ] ] ), disable_web_page_preview=True, )
